...
export default function Page() {
  return (
    <>
      ...
      {/* Ambient Glows */}
      <div
        className="fixed -top-50 w-auto h-auto pointer-events-none z-0"
        style={{
          background:
      ...
      />
      <div
        className="fixed -bottom-50 -left-25 w-auto h-auto pointer-events-none z-0"
        style={{
          background:
      ...
      <div className="w-full max-w-full bg-[#0a0a0f] min-h-screen text-[#f0f0f5] overflow-x-hidden px-6 sm:px-8 pb-24">
        ...
        <nav className="flex items-center sm:justify-between justify-center flex-wrap gap-3 mb-14 pt-7 animate-fade-up">
          <span
            className="font-mono-jb text-lg font-semibold tracking-wide"
            style={{ color: "#00d4aa" }}
          >
            Jashandeep Singh
          </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-10 sm:gap-12 items-center">
            <div>
              ...
              <div className="flex items-center gap-2.5 mb-5 flex-wrap">
                <span
                  className="inline-flex items-center gap-1.5 text-sm font-semibold px-3 py-1 rounded-full border font-mono-jb tracking-[0.01em]"
                  style={{
                ...
                >
                  <span
                    className="badge-dot w-1.75 h-1.75 rounded-full shrink-0"
              ...
              <div className="font-mono-jb text-[#8888aa] mb-5 tracking-[0.02em]">
                ...
                Full Stack Developer · BCA 5th Semester
              </div>

              {/* Bio */}
              <p
                className="text-[#8888aa] leading-[1.75] mb-7 max-w-220"
                style={{ fontSize: "clamp(15px, 2.5vw, 17px)" }}
              >
                I&apos;m a{" "}
                <strong className="text-[#f0f0f5] font-semibold">
                ...
                My focus is backend engineering: APIs, databases, and real
                deployments that actually ship.
              </p>

              {/* Links */}
              <div className="flex gap-3 flex-wrap">
                <a
                  href="mailto:dhimanjashan548@gmail.com"
                ...
                <a
                  href="https://github.com/dhimanjashan"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/jashan04/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-outline-custom inline-flex items-center gap-2 text-sm font-semibold px-5 py-2.75 rounded-[10px] text-[#f0f0f5] no-underline border border-[rgba(255,255,255,0.15)] bg-[#12121a] cursor-pointer"
                >
        ...
        <div className="py-10 animate-fade-up-2">
          <div className="flex items-center gap-3.5 mb-5">
            <span
              className="font-mono-jb text-lg font-semibold tracking-[0.18em] uppercase whitespace-nowrap"
              style={{ color: "#00d4aa" }}
            >
              About
            </span>
          ...
          <div className="hover-card bg-[#12121a] border border-[rgba(255,255,255,0.07)] rounded-2xl p-7">
            <p className="text-lg text-[#8888aa] leading-[1.8] mb-6">
              I started coding to build real things, not just to pass exams. I
              learn by doing — every concept I study goes straight into a
              project. I&apos;m looking for my first real role where I can{" "}
              <strong className="text-[#f0f0f5] font-semibold">
                contribute, grow fast, and keep building
              </strong>
              .
            </p>
            <div className="grid  grid-cols-2 sm:grid-cols-4 gap-3.5">
              {[
                ...
                },
                {
                  ...
                  val: "5–6 hours every day",
                },
              ].map(({ icon, label, val }) => (
                <div
                  key={label}
                  className="flex flex-col gap-1.5 p-3.5 bg-[#1a1a26] rounded-xl border border-[rgba(255,255,255,0.07)]"
                >
                  <div
                    className="w-8.5 h-8.5 rounded-[9px] flex items-center justify-center mb-1"
                    style={{
                      color: "#6c63ff",
                  ...
                  <div className="text-xs font-semibold text-[#8888aa] tracking-[0.05em] uppercase">
                    {label}
                  </div>
                  <div className="text-sm text-[#f0f0f5] font-medium leading-snug">
                    {val}
                  </div>
                </div>
              ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              },
              {
                icon: <Server size={18} />,
                name: "Backend",
                tags: ["Node.js", "Express", "REST API", "MVC"],
              },
              {
                icon: <Database size={18} />,
                name: "Database",
                tags: ["MongoDB", "Atlas", "Mongoose"],
              },
            ].map(({ icon, name, tags }) => (
              <div
                key={name}
                className="hover-card hover-skill bg-[#12121a] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5.5 cursor-default"
              >
                <div
                ...
                <div className="font-syne text-lg font-bold text-[#f0f0f5] mb-3">
                  {name}
                </div>
                <div className="flex flex-wrap gap-1.5">
                  {tags.map((tag) => (
                    <span
                      key={tag}
                      className="skill-tag-inner font-mono-jb text-sm bg-[#1a1a26] border border-[rgba(255,255,255,0.07)] text-[#8888aa] px-2 py-1 rounded-md transition-all duration-150"
                    >
                      {tag}
                    </span>
                  ))}
        ...
        <div className="py-10 animate-fade-up-4" id="projects">
          ...
          <div className="flex flex-col gap-3.5">
            {[
              ...
              // },
            ].map(({ num, title, status, link, desc, tags }) => (
              <div
                key={title}
                className="hover-card hover-project bg-[#12121a] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 cursor-pointer flex items-start justify-between gap-4"
              >
                <div className="flex-1 min-w-0">
                  <div className="font-mono-jb text-xs text-[#8888aa] mb-2 opacity-60">
                    {num}
                  </div>
                  <div className="flex items-center gap-2.5 mb-2.5 flex-wrap">
                    <span className="font-syne text-xl font-bold text-[#f0f0f5] tracking-[-0.01em]">
                      {title}
                    </span>
                    {status && (
                      <span
                  ...
                  <p className="text-lg text-[#8888aa] leading-[1.7] mb-3.5 max-w-180">
                    {desc}
                  </p>
                  <div className="flex gap-1.5 flex-wrap">
                    {tags.map((tag) => (
                      <span
                        key={tag}
                        className="font-mono-jb text-sm px-2 py-1 rounded-md"
                        style={{
                ...
                >
                  <ExternalLink
                    size={16}
                    className="proj-arrow shrink-0 mt-1"
                  />
                </a>
              </div>
            ))}
          ...
          <div className="hover-card bg-[#12121a] border border-[rgba(255,255,255,0.07)] rounded-2xl p-7">
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                {
                  hours: "1h",
                  label: "Interview prep (DSA & concepts)",
                  pct: 30,
                },
                {
                  hours: "1h",
                  label: "English communication practice",
                  pct: 30,
                },
                ...
                <div
                  key={label}
                  className="hover-routine flex items-center gap-4 px-4.5 py-3.5 rounded-[10px] bg-[#1a1a26] border border-[rgba(255,255,255,0.07)] transition-all duration-200"
                >
                  <span
                    className="font-mono-jb text-lg font-semibold min-w-11 shrink-0"
                    style={{ color: "#00d4aa" }}
                  >
                    {hours}
                  </span>
        ...
        <div className="py-10 animate-fade-up-6" id="contact">
          ...
          <div className="contact-glow hover-card bg-[#12121a] border border-[rgba(255,255,255,0.07)] rounded-2xl px-8 py-12 text-center relative overflow-hidden">
            <h2
              className="font-syne font-extrabold mb-3 tracking-[-0.02em] grad-text-muted"
            ...
            <p className="text-base text-[#8888aa] mb-7 leading-[1.7] max-w-100 mx-auto">
              ...
              If you&apos;re hiring or just want to talk tech, I&apos;d love to
              hear from you.
            </p>
